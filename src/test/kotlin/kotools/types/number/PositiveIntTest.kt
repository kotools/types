...
class PositiveIntTest {
    ...
    inner class CompareTo {
        ...
        @Test
        fun `should return 0 when comparing an int with the same positive int`() {
            // GIVEN
            val x = 1
            val y = PositiveInt(x)
            // WHEN
        ...
        @Test
        fun `should return a negative number when comparing an int with a greater positive int`() {
            // GIVEN
            val x = 0
            val y = PositiveInt(x + 1)
            // WHEN
            val result: Int = x compareTo y
            // THEN
            assertTrue { result < 0 }
        ...
        @Test
        fun `should return a positive number when comparing an int with a less positive int`() {
            // GIVEN
            val x = 1
            val y = PositiveInt(x - 1)
            // WHEN
