...
public class NonNegativeInteger private constructor(
     ...
     * Here's an example of calling this function from Kotlin code:
     *
     * SAMPLE: org.kotools.types.number.NonNegativeIntegerSample.timesWithNonPositiveInteger
     * </details>
     *
     * <br>
     * <details>
     ...
     * Here's an example of calling this function from Java code:
     *
     * SAMPLE: org.kotools.types.number.NonNegativeIntegerJavaSample.timesWithNonPositiveInteger
     * </details>
     */
    public operator fun times(other: NonPositiveInteger): NonPositiveInteger =
        NonPositiveInteger.fromInteger(this.value * other.toInteger())
